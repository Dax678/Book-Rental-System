...
import org.bookrental.bookrentalsystem.Config.Exception.EmailAlreadyExistsException;
...
public class AuthService {
    ...
    public RegisterResponse signup(RegisterRequest request) {
        if(isEmailTaken(request.getEmail())) throw new EmailAlreadyExistsException("Account with an email: \"" + request.getEmail() + "\" already exists.");
